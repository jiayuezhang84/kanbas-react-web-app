          ...
          <div className="wd-selector-2">
            ...
            <p className="wd-selector-3">
              ...
              <span className="wd-selector-4">
                Whereas this span is a direct child of its parentß
              </span><br />
...
<div id="wd-css-navigating-with-tabs">
  ...
  <ul className="nav nav-tabs">
    <li className="nav-item">
        <a className="nav-link active" href="https://registrar.northeastern.edu/article/academic-calendar/">Active</a>
    </li>
    <li className="nav-item">
        <a className="nav-link" href="https://www.northeastern.edu/">Link</a>
    </li>
    <li className="nav-item">
        <a className="nav-link" href="https://news.northeastern.edu/2024/05/30/magazine/podcast-music-licensing/?utm_source=northeastern.edu&utm_medium=website&utm_campaign=northeastern.edu+homepage&utm_id=northeastern.edu+homepage">Link</a>
    </li>
    <li className="nav-item">
        <a className="nav-link disabled" href="https://news.northeastern.edu/research/">Disabled</a>
    </li>
  </ul>
</div>
<div id="wd-css-navigating-with-cards">
  ...
  <div className="card"
    ...
    <div className="card-body">
      ...
      Your personal guide to the wonderful world of dogs.
      </p>
      <a href="https://character.ai/chat/MtIiN1YrgZySDWDNn04__BM5Zyr5nrNuJcyf7EwzbdQ" className="btn btn-primary">
        Try it!
      </a>
    </div>
  </div>
