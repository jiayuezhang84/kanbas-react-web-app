export default function Lab1() {
  return (
    <div id="wd-lab1" className="lab1">
      ...
      <div id="wd-p-tag">
        <h4>2. Paragraph Tag</h4>
        <p id="wd-p-1" style={{ backgroundColor: 'white', color: 'black' }}>
          This is a paragraph.
        ...
        <p id="wd-p-2 " style={{ backgroundColor: 'white', color: 'black' }}>
          This is the first paragraph. The paragraph tag is used to format
          vertical gaps between long pieces of text like this one.
        </p>
        <p id="wd-p-3" style={{ backgroundColor: 'white', color: 'black' }}>
          This is the second paragraph. Even though there is a deliberate white
          gap between the paragraph above and this paragraph, by default
          browsers render them as one contiguous piece of text as shown here on
          the right.
        </p>
        <p id="wd-p-4"style={{ backgroundColor: 'white', color: 'black' }} >
      ...
      <div id="wd-lists">
        ...
        My favorite recipe to make milkshake:
        <ol id="wd-your-favorite-recipe">
          <li>Soften the ice cream and chill the glass.</li>
          <li>Measure the ingredients.</li>
          <li>Blend the shake.</li>
          <li>Serve.</li>
        </ol>
        <h5>3.2 Unordered List Tag</h5>
        ...
        Jiayue's favorite books (in no particular order)
        <ul id="wd-your-books">
          <li>Proof of Heaven</li>
          <li>Mindset</li>
          <li>The Crowded</li>
          <li>The Hobbit</li>
          <li>Animal Farm</li>
        ...
        <div id="wd-images">
          ...
          <br />
          <img id="wd-teslabot" src="images/earth.avif" alt="" height="200px" />
        </div>

        <div id="wd-forms">
          <h4>6 Form Elements</h4>
          <form id="wd-text-fields">
            <h5>6.1 Text Fields</h5>
        ...
        <h5 id="wd-buttons">6.3 Buttons</h5>
        <button id="wd-all-good" onClick={() => alert("Life is Good!")} type="button">
          Hello World!
        </button>
        <h5>6.4 File upload</h5>
        <input id="wd-upload" type="file" />
        <h5 id="wd-radio-buttons">6.5 Radio buttons</h5>
        ...
        <h5 id="wd-checkboxes">6.6 Checkboxes</h5>
        <label>Favorite movie genre:</label><br />
